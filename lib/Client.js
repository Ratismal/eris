...
class Client extends EventEmitter {
    ...
    * @arg {String} [options.avatarType=true] The filetype of avatarURLs. Either "jpg", "png", "gif", or "webp"
    */
    constructor(token, options) {
        ...
        if(["jpg", "png", "gif", "webp"].indexOf(this.options.avatarType.toLowerCase()) == -1) {
            this.options.avatarType = "jpg";
        }
