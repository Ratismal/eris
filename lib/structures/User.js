...
class User extends Base {
    ...
    get avatarURL() {
        return this.avatar ? `${CDN_URL}/avatars/${this.id}/${this.avatar}.${this.avatar.startsWith("a_") ? "gif" : this._client.options.avatarType.toLowerCase()}` : this.defaultAvatarURL;
    }
